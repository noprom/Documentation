...
docker pull daocloud.io/noprom/noprom-nginx:latest
docker pull daocloud.io/noprom/noprom-redis:latest
docker pull daocloud.io/noprom/noprom-mysql:latest
docker pull daocloud.io/noprom/noprom-php:latest
```
